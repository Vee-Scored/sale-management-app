      ...
      return function() {
        ...
        function a(e2, t2) {
          ...
          setTimeout(() => {
            var t3, d2;
            if (e2.contentWindow)
              if (e2.contentWindow.focus(), a2)
                a2(e2).then(() => null == n2 ? void 0 : n2()).then(() => l(s2)).catch((e3) => {
                ...
                if (e2.contentWindow.print) {
                  ...
                  i({ messages: ["Printing for this browser is not currently possible: the browser does not have a `print` method available for iframes."], suppressErrors: c2 });
                null == n2 || n2(), l(s2);
              }
            else
              i({ messages: ["Printing failed because the `contentWindow` of the print iframe did not load. This is possibly an error with `react-to-print`. Please file an issue: https://github.com/MatthewHerbst/react-to-print/issues/"], suppressErrors: c2 });
          }, 500);
        }
        function c(e2) {
        ...
        function d(e2, t2, o2) {
          ...
          if (n2.length === r2.length)
            ...
            i({ messages: ["When cloning shadow root content, source and target elements have different size. `onBeforePrint` likely resolved too early.", e2, t2], suppressErrors: o2 });
        }
          ...
          if (x) {
            ...
            for (let e3 = 0; e3 < h2.length; e3++) {
              ...
              if (n4) {
                ...
                t2(o4, ['Found an <img> tag with an empty "src" attribute. This prevents pre-loading it.', o4]);
            }
            for (let e3 = 0; e3 < f2.length; e3++) {
              ...
              if (n4) {
                ...
                o4.readyState >= 2 ? t2(o4) : (o4.onloadeddata = () => t2(o4), o4.onerror = (e4, n5, r4, s3, i2) => t2(o4, ["Error loading video", o4, "Error", i2]), o4.onstalled = () => t2(o4, ["Loading video stalled, skipping", o4]));
            }
            const g2 = "select", S = c2.querySelectorAll(g2), k = x.querySelectorAll(g2);
            for (let e3 = 0; e3 < S.length; e3++)
              k[e3].value = S[e3].value;
            if (!v) {
                  ...
                  if (t3) {
                    ...
                    try {
                      ...
                      for (let o5 = 0; o5 < e5; ++o5)
                        "string" == typeof t3.cssRules[o5].cssText && (r4 += `${t3.cssRules[o5].cssText}\r
`);
                    } catch (e5) {
                  ...
                  i({ messages: ["`react-to-print` encountered a <link> tag with an empty `href` attribute. In addition to being invalid HTML, this can cause problems in many browsers, and so the <link> was not loaded. The <link> is:", n5], level: "warning" }), t2(n5);
              }
            }
          }
          0 === g && a(e2, n2);
        ...
        function f(e2) {
          const { contentRef: t2, fonts: o2, ignoreGlobalStyles: n2, onBeforePrint: r2, onPrintError: c2, preserveAfterPrint: d2, suppressErrors: u2 } = e2, p2 = (0, s.useCallback)((s2) => {
            ...
            if (!p3)
              return void i({ messages: ["There is nothing to print"], suppressErrors: u2 });
